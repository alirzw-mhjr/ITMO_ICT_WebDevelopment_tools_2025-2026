...
Revision ID: b421cb3180ba
Revises: c61d1d17d7de
Create Date: 2026-04-18 22:15:13.289003
...
revision: str = 'b421cb3180ba'
down_revision: Union[str, Sequence[str], None] = 'c61d1d17d7de'
...
def upgrade() -> None:
    ...
    sa.Column('requested_userbook_id', sa.Integer(), nullable=False),
    sa.Column('offered_userbook_id', sa.Integer(), nullable=False),
