...
Revision ID: e35c40beb6ee
Revises: 
Create Date: 2026-04-11 06:36:56.771719
...
def upgrade() -> None:
    ...
    sa.Column('authors', sqlmodel.sql.sqltypes.AutoString(length=300), nullable=False),
    ...
    sa.Column('book_id', sa.Integer(), nullable=False),
    sa.Column('condition', sa.Enum('NEW', 'GOOD', 'USED', 'DAMAGED', name='bookcondition'), nullable=False),
